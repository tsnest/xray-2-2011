...
#ifndef XRAY_RENDER_ENGINE_PS3_WORLD_H_INCLUDED
#define XRAY_RENDER_ENGINE_PS3_WORLD_H_INCLUDED
...
public:
	...
	void update_preview_particle_system_transform	( particle::particle_system** preview_ps, scene_ptr const& in_scene, math::float4x4 const& transform );
			...
			void	set_particles_render_mode		( scene_view_ptr const& view_ptr, xray::particle::enum_particle_render_mode render_mode );
...
#endif // #ifndef XRAY_RENDER_ENGINE_PS3_WORLD_H_INCLUDED
