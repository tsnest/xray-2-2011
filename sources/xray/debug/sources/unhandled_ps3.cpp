...
#pragma message( XRAY_TODO("PS3: unhandled exception handler") )
	...
	//xray::debug::detail::generate_file_name			( temp, date_time, xray::core::application_name(), "error_report", ".log");
	...
	//xray::logging::flush_log_file		( xray::fs_new::convert_to_portable_in_place(portable_log_file_name) );

	//xray::debug::bugtrap::add_file		( log_file_name );
	//xray::debug::platform::save_minidump	( date_time, exception_information );
}
