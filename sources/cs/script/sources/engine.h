...
#	define CS_LUA_STUDIO_BACKEND_USE_DEBUG_LIBRARY
...
{
public:
	virtual	int				CS_LUA_STUDIO_BACKEND_CALL	luaL_loadstring				(lua_State* L, char const* s);
	virtual	int				CS_LUA_STUDIO_BACKEND_CALL	luaL_newmetatable			(lua_State* L, char const* tname);
...
public:
	...
	virtual	int				CS_LUA_STUDIO_BACKEND_CALL	lua_getinfo					(lua_State* L, char const* what, lua_Debug* ar);
	virtual	void			CS_LUA_STUDIO_BACKEND_CALL	lua_getfenv					(lua_State* L, int idx);
	virtual	void			CS_LUA_STUDIO_BACKEND_CALL	lua_getfield				(lua_State* L, int idx, char const* k);
	virtual	char const*		CS_LUA_STUDIO_BACKEND_CALL	lua_getlocal				(lua_State* L, lua_Debug const* ar, int n);
	...
	virtual	void			CS_LUA_STUDIO_BACKEND_CALL	lua_pushstring				(lua_State* L, char const* s);
	...
	virtual	void const*		CS_LUA_STUDIO_BACKEND_CALL	lua_topointer				(lua_State* L, int idx);
